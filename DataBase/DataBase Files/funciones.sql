...
insert into T_ROLE (NAME) values('Centro de Atención Adulto Mayor Rincón de Ricardo');
...
insert into T_USER_ROLE (USER_ID,ROLE_NAME) values('haciendamunicipal@sanpablo.go.c','Dirección de hacienda Muninicipal');
...
insert into T_USER (TEMPUSER,PASSWORD,DEPARTMENT,STATUS) values
 ('planificacionpresupuestocontrol@sanpablo.go.cr','$2y$12$ywJ1xt5cpjgt3.JBKHr9teDSyq8xAlK4oi2uyTxnJmyBe.hd9IWeq',3,1); --pass:planificacionpresupuestocontrol
